...
- **Линза преломляет пиксели, а не DOM.** Сцену ей даёт снимок видимой области вкладки
  ...
  деталь вырождается в плашку. На время снимка виджет прячется, чтобы стекло не начало
  преломлять само себя. Снимок никуда не уходит: он живёт в текстуре на той же странице.
...
Если WebGL2 недоступен или снимок не получен, панель падает на `backdrop-filter` и
остаётся рабочей — просто без преломления.
